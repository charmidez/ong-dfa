...
export const nosDomainesDinterventionData = {
  titre: "Nos Domaines d'intervention",
  description: [
    {
      titre: "Formation des jeunes défavorisés",
      desc: `Nous offrons des formations pratiques et professionnelles aux jeunes issus de milieux modestes pour favoriser leur insertion socio-économique. 
      Nos programmes portent notamment sur l’entrepreneuriat, les métiers techniques, l’agriculture durable et les compétences numériques.`,
      objectif: "Lutter contre le chômage et l’exclusion sociale des jeunes.",
      bgColor: "bg-amber-900",
      icon: "/icons/education.png",
    },

    {
      titre: "Restauration de l’environnement",
      desc: `Conscients des enjeux climatiques, nous menons des actions pour la protection et la restauration des écosystèmes : 
      reboisement, gestion durable des déchets, éducation environnementale dans les écoles, etc.`,
      objectif:
        "Promouvoir un environnement sain pour les générations futures.",
      bgColor: "bg-blue-900",
...

    {
      ...
      en partenariat avec des acteurs techniques et institutionnels.`,
      objectif:
        "Réduire l’habitat précaire et améliorer les conditions de vie.",
...

    {
      ...
      objectif:
        "Renforcer le développement local par des infrastructures durables.",
